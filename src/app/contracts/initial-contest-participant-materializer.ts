...
export interface InitialParticipantPlacement{readonly contestPlanRef:string;readonly participant:Omit<Extract<ContestParticipant,{sourceType:"seed"}>,"contestId">;}
