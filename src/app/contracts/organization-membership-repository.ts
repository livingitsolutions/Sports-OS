...
export type OrganizationMembershipListResult = { readonly kind: "found"; readonly memberships: readonly OrganizationMembership[] } | { readonly kind: "invalid_persistence_state" | "unavailable"; readonly detail?: string };
export interface OrganizationMembershipRepository {
  ...
  findActiveByPerson(personId: Id<"Person">): Promise<OrganizationMembershipListResult>;
}
