...
export interface CompetitionFormatMaterializationState {readonly competitionFormatId:CompetitionFormat["id"];readonly entrantCount:number;readonly seedFinalizedAt:ISODateString|null;}
