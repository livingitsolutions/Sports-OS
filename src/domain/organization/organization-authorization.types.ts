...
export const ORGANIZATION_PERMISSIONS=["organization.read","organization.update","organization.members.read","organization.members.manage","organization.roles.read","organization.roles.manage","organization.trust.read","organization.trust.manage","organization.teams.read","organization.teams.manage","organization.events.read","organization.events.manage"] as const;
